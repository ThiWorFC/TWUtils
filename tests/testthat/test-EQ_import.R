test_that("EQ_import() for EyeQuestion format file", {
  ...
  data <- EQ_import(system.file("extdata", "EQ_data.xlsx", package = "TWUtils"), convert2num=TRUE)
  exp <- readr::read_csv(system.file("extdata", "EQ_expected.csv", package = "TWUtils")) |>
